      ...
      <S.HomeContent id="start">
        <section className="thirdContent">
          ...
          >
            <div
              id="slideItem"
              className={`firstSlide ${currentSlide === 0 ? "" : "opacity"}`}
            >
              <div
                className={`firstSlideTitle ${currentSlide === 0 ? "" : "opacity"}`}
              >
                추천을 위한
                <br />
                예리한 질문들
              ...
              <div
                className={`slideButton ${currentSlide === 0 ? "" : "opacity"}`}
                onClick={handleRecommend}
              >
                <p
                  className={`slideButtonText ${currentSlide === 0 ? "" : "opacity"}`}
                >
                  추천받기
                </p>
                <img
                  className={`slideButtonIcon ${currentSlide === 0 ? "" : "opacity"}`}
                  src={arrow}
                  alt="추천받기로 이동하기"
                />
              </div>
              <img
                className={`firstSlideImg1 ${currentSlide === 0 ? "active" : "opacity"}`}
                src={recommend1}
                alt="무엇을 추천해 드릴까요?"
              />
              <img
                className={`firstSlideImg2 ${currentSlide === 0 ? "active" : "opacity"}`}
                src={recommend2}
                alt="운동 & 보조제"
              />
            </div>
            <div
              id="slideItem"
              className={`secondSlide ${currentSlide === 1 ? "" : "opacity"}`}
            >
              <div
                className={`secondSlideTitle ${currentSlide === 1 ? "" : "opacity"}`}
              >
                <span
                  className={`secondSlideTitleTop ${currentSlide === 1 ? "" : "opacity"}`}
                >
                  AI가 제공하는
                  <br />
                  운동 추천 보고서
                ...
                <p
                  className={`secondSlideTitleBottom ${currentSlide === 1 ? "" : "opacity"}`}
                >
                  운동량까지 추천해주는 센스.
                </p>
              </div>
              <div
                className={`slideButtonBorder2 ${currentSlide === 1 ? "" : "opacity"}`}
                onClick={handleRecommend}
              >
                <div
                  className={`slideButton2 ${currentSlide === 1 ? "" : "opacity"}`}
                >
                  <p
                    className={`slideButtonText2 ${currentSlide === 1 ? "" : "opacity"}`}
                  >
                    AI 추천 보고서
                  </p>
                  <img
                    className={`slideButtonIcon ${currentSlide === 1 ? "" : "opacity"}`}
                    src={brandArrow}
                    alt="추천받기로 이동하기"
                    fill={theme.Brand600}
                  />
              ...
              <img
                className={`secondSlideImg ${currentSlide === 1 ? "active" : "opacity"}`}
                src={recommend3}
                alt="추천결과"
              />
            </div>
            <div
              id="slideItem"
              className={`thirdSlide ${currentSlide === 2 ? "" : "opacity"}`}
            >
              <div
                className={`thirdSlideTitle ${currentSlide === 2 ? "" : "opacity"}`}
              >
                루틴도
                <br />한 번에 관리하세요
              </div>
              <div
                className={`slideButton ${currentSlide === 2 ? "" : "opacity"}`}
                onClick={handleMyPage}
              >
                <p
                  className={`slideButtonText ${currentSlide === 2 ? "" : "opacity"}`}
                >
                  내 운동
                </p>
                <img
                  className={`slideButtonIcon ${currentSlide === 2 ? "" : "opacity"}`}
                  src={arrow}
                  alt="내운동으로 이동하기"
                />
              </div>
              <img
                className={`thirdSlideImg ${currentSlide === 2 ? "active" : "opacity"}`}
                src={mypage}
                alt="마이루틴"
              />
            </div>
      ...
      <S.HomeContent>
        <section className="fourthContent">
          <div className="fourthTitle">
            <p className="firstTitleText">핏메이트가 다 알려줄게요</p>
